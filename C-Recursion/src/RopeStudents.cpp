...
int getCountMin(struct student *leaderStudent)
{
	if (leaderStudent)
		return 1 + min(getCountMin(leaderStudent->first), getCountMin(leaderStudent->second), getCountMin(leaderStudent->third));
	return 0;
}

int getCountMax(struct student *leaderStudent)
{
	if (leaderStudent)
		return 1 + max(getCountMax(leaderStudent->first), getCountMax(leaderStudent->second), getCountMax(leaderStudent->third));
	return 0;
}

void findBallDistance(struct student *leaderStudent, int *minBallDistance, int *maxBallDistance)
{
	*minBallDistance=getCountMin(leaderStudent);
	*maxBallDistance=getCountMax(leaderStudent);
}
